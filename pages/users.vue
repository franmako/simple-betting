      ...
      <div class="mx-10 my-2">
        ...
        <div class="mt-6 flex justify-between text-gray-600 dark:text-gray-400">
          ...
          <div class="ml-10 pl-2 flex capitalize">
            ...
            <span class="ml-8 flex items-center">
              name
              <svg
                class="ml-1 h-5 w-5 fill-current text-green-500 dark:text-green-200"
                viewBox="0 0 24 24"
              >
                <path
        ...
        >
          ...
          <div class="flex justify-between">
            ...
            <div
              class="ml-12 flex flex-col capitalize text-gray-600 dark:text-gray-400"
            >
              <span>login</span>
              <span class="mt-2 text-black dark:text-gray-200">
                carmen.bel
        ...
        <div
          class="mt-8 mb-4 flex px-4 py-4 justify-between bg-white dark:bg-gray-600 shadow-xl rounded-lg cursor-pointer"
        >
          <!-- Card -->
